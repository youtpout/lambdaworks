...
/// Only available when shaders were successfully compiled (macOS with source present).
#[cfg(metal_shaders_compiled)]
...
///
/// Only available when Metal shaders were successfully compiled at build time.
/// Operations that compile shaders at runtime (MSM, Merkle) use [`DynamicMetalState`] instead.
///
/// # Example
///
/// ```ignore
